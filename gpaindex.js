const calc = () => {
    ...
    if (sub7 != 'grade') {
        ...
        if (sub7 == 'S') {
            gradeScr += (parseFloat(crd7 * 10));
        }
        else if (sub7 == 'A') {
            gradeScr += (parseFloat(crd7 * 9));
        }
        else if (sub7 == 'B') {
            gradeScr += (parseFloat(crd7 * 8));
        }
        else if (sub7 == 'C') {
            gradeScr += (parseFloat(crd7 * 7));
        }
        else if (sub7 == 'D') {
            gradeScr += (parseFloat(crd7 * 6));
        }
        else if (sub7 == 'E') {
            gradeScr += (parseFloat(crd7 * 5));
        }
        else {
            gradeScr += (parseFloat(crd7 * 0));
        }
    }
    ...
    if (sub8 != 'grade') {
        ...
        if (sub8 == 'S') {
            gradeScr += (parseFloat(crd8 * 10));
        }
        else if (sub8 == 'A') {
            gradeScr += (parseFloat(crd8 * 9));
        }
        else if (sub8 == 'B') {
            gradeScr += (parseFloat(crd8 * 8));
        }
        else if (sub8 == 'C') {
            gradeScr += (parseFloat(crd8 * 7));
        }
        else if (sub8 == 'D') {
            gradeScr += (parseFloat(crd8 * 6));
        }
        else if (sub8 == 'E') {
            gradeScr += (parseFloat(crd8 * 5));
        }
        else {
            gradeScr += (parseFloat(crd8 * 0));
        }
    }
    ...
    if (sub9 != 'grade') {
        ...
        if (sub9 == 'S') {
            gradeScr += (parseFloat(crd9 * 10));
        }
        else if (sub9 == 'A') {
            gradeScr += (parseFloat(crd9 * 9));
        }
        else if (sub9 == 'B') {
            gradeScr += (parseFloat(crd9 * 8));
        }
        else if (sub9 == 'C') {
            gradeScr += (parseFloat(crd9 * 7));
        }
        else if (sub9 == 'D') {
            gradeScr += (parseFloat(crd9 * 6));
        }
        else if (sub9 == 'E') {
            gradeScr += (parseFloat(crd9 * 5));
        }
        else {
            gradeScr += (parseFloat(crd9 * 0));
        }
    }
    ...
    if (sub10 != 'grade') {
        ...
        if (sub10 == 'S') {
            gradeScr += (parseFloat(crd10 * 10));
        }
        else if (sub10 == 'A') {
            gradeScr += (parseFloat(crd10 * 9));
        }
        else if (sub10 == 'B') {
            gradeScr += (parseFloat(crd10 * 8));
        }
        else if (sub10 == 'C') {
            gradeScr += (parseFloat(crd10 * 7));
        }
        else if (sub10 == 'D') {
            gradeScr += (parseFloat(crd10 * 6));
        }
        else if (sub10 == 'E') {
            gradeScr += (parseFloat(crd10 * 5));
        }
        else {
            gradeScr += (parseFloat(crd10 * 0));
        }
    }


    let gpa = (gradeScr / totalCred);
    document.getElementById('showGPA').innerHTML = `<strong>${gpa.toFixed(2)}</strong>`;
    document.getElementById('showCred').innerHTML = `<strong>${totalCred}</strong>`;
}

const resetForm = () => {
    // Reset all input fields to empty
    document.getElementById('sub1').value = 'grade';
    document.getElementById('sub2').value = 'grade';
    document.getElementById('sub3').value = 'grade';
    document.getElementById('sub4').value = 'grade';
    document.getElementById('sub5').value = 'grade';
    document.getElementById('sub6').value = 'grade';
    document.getElementById('sub7').value = 'grade';
    document.getElementById('sub8').value = 'grade';
    document.getElementById('sub9').value = 'grade';
    document.getElementById('sub10').value = 'grade';
    ...
    document.getElementById('subject 10').value = '';
